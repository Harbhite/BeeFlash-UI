...
export const LayoutDoubleIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="8" height="18" x="3" y="3" rx="2"/><rect width="8" height="18" x="13" y="3" rx="2"/></svg>
);
export const LayoutMasonryIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="8" height="11" x="3" y="3" rx="2"/><rect width="8" height="7" x="13" y="3" rx="2"/><rect width="8" height="7" x="3" y="14" rx="2"/><rect width="8" height="11" x="13" y="10" rx="2"/></svg>
);
